...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://demo-lookincasino.com/css/reviews.css">
...
<body class="">
    ...
    <div class="wrapper">
        ...
        <main class="content">
            ...
            <section class="block block-banner-slider text" style="background-image: url('https://demo-lookincasino.com/img/reviews-banner.jpg');">
                <div class="wrap">
                    <div class="banner-slider" id="banner-slider">
                        <div class="slide">
                            <div class="slide-content">
                                <div class="slide-title">
                                    4 737 игроков уже поделились <br>
                                    своими лучшими советами
                                </div>
                                <div class="slide-title-descr">
                                    А как прошел Ваш игровой тур? 
                                </div>
                                <div class="slide-descr">
                                    <p>
                                        Ваше мнение Важно для нас!<br>
                                        Для того чтобы оставить свой отзыв, необходимо пройти <br>
                                        регистрацию или войти в свой аккаунт
                                    </p>
                                </div>
            ...
            <section class="block-info-reviews">
                <div class="wrap">
                        ...
                        <div class="reviews">
                            <div class="review-item main">
                                <div class="review-body">
                                    <div class="review-post-head">
                                        ...
                                        <div class="post-rate">
                                            <div class="item-stars stars-rate-group">
                                                ...
                                                <div class="stars-rate yellow stars-rate-current" style="width: calc((5.0 * 12px) + (5 * 7px))">
                                                    <div class="star"></div>
                                                    <div class="star"></div>
                                                    <div class="star"></div>
                                                    <div class="star"></div>
                                    ...
                                    <div class="title">
                                        Просто шикарное казино!
                                    </div>
                                    <div class="descr">
                                        Очень красивый интерьер, обслуживание на высшем уровне.
                                        Посетителю предлагаются бесплатные напитки, сигареты, закуски и десерты. Для кого-то хорошо, а для кого-то не очень, а в казино можно курить. Здесь много игровых столов (покер, рулетка) и более 150 игровых автоматов (правда, игры почти везде одинаковые), есть джекпот!.. Если буду в Грузии ещё раз, обязательно загляну в это казино! Для посещения казино потребуется паспорт, на ресепшн выдадут пластиковую карту (депозитная сумма не требуется), персонал всё объяснит, там все большие молодцы. Большинство игроков казино - граждане Турции, и туристы из других стран, а сами грузины играют мало.
                                    </div>
                                    <div class="controls">
                                        <a href="/" class="button blue review-details-link">
                                            Подробнее
                                        </a>
                                ...
                                <div class="review-info">
                                    ...
                                    <div class="buttons">
                                        <a href="https://demo-lookincasino.com/individual-casino/" class="button blue casino-link">Обзор казино</a>
                                        <a href="/" class="button white-bluelight add-review-link">Оставить отзыв</a>
                                    </div>
                                </div>
                            </div>
                            <div class="review-item">
                                <div class="review-body">
                                    ...
                                    <div class="title">
                                        Казино хорошее, спасибо персоналу
                                    </div>
                                    <div class="descr">
                                        Очень красивый интерьер, обслуживание на высшем уровне. Посетителю предлагаются бесплатные напитки, сигареты, закуски и десерты. Для кого-то хорошо, а для кого-то не очень, а в казино можно курить.
                                    </div>
                                    <div class="controls">
                                        <a href="/" class="button blue review-details-link">
                                            Подробнее
                                ...
                                <div class="review-info">
                                    <div class="head-column left">
                                        <div class="logo">
                                            <img src="https://demo-lookincasino.com/img/logo-dummy-4.jpg">
                                        </div>
                                        <div class="title">
                                            Казино 1
                                        </div>
                                    ...
                                    <div class="head-column right">
                                        <div class="rate-and-stars">
                                            ...
                                            <div class="item-stars stars-rate-group">
                                                ...
                                                <div class="stars-rate yellow stars-rate-current" style="width: calc((3.9 * 12px) + (3 * 7px))">
                                                    <div class="star"></div>
                                                    <div class="star"></div>
                                                    <div class="star"></div>
                                                    <div class="star"></div>
                            ...
                            <div class="review-item">
                                <div class="review-body">
                                    <div class="review-post-head">
                                        <div class="post-info">
                                            <div class="photo" style="background-image: url('https://demo-lookincasino.com/img/user-blue-dummyjpg');"></div>
                                            <div class="info">
                                                <div class="author">
                                                    Имя Фамилия
                                                </div>
                    ...
                    <aside class="short-reviews-column">
                        <div class="aside-group">
                            ...
                            <div class="auth">
                                <div class="descr">
                                    ...
                                    посещения игорного заведения<br>
                                    <br>
                                    Для того чтобы оценить казино,
                                    необходимо пройти <a href="/" class="modal-registration-button">регистрацию</a>
                                    или <a href="/" class="modal-login-button">войти</a> в свой аккаунт
                                </div>
                                <a href="/" class="button white-bluelight add-review-link">Оценить казино</a>
                            </div>
                        </div>
                        <div class="aside-group">
                            <div class="block-title">
                                Рейтинг казино по оценкам в отзывах
                            </div>
                            <div class="short-reviews">
                                <div class="short-review-item">
                                    ...
                                    <div class="info-column">
                                        <div class="rate-and-stars">
                                            ...
                                            <div class="item-stars stars-rate-group">
                                                ...
                                                <div class="stars-rate yellow stars-rate-current" style="width: calc((3.0 * 12px) + (3 * 7px))">
                                                    <div class="star"></div>
                                                    <div class="star"></div>
                                                    <div class="star"></div>
                                                    <div class="star"></div>
                        ...
                        <div class="aside-group">
                            <div class="block-title">
                                Рейтинг покерных клубов по оценкам в отзывах
                            </div>
                            <div class="short-reviews">
                                <div class="short-review-item">
                                    <div class="info-column">
                        ...
                        <div class="aside-group">
                            <div class="block-title">
                                Рейтинг букмекерских контор по оценке в отзывах
                            </div>
                            <div class="short-reviews">
                                <div class="short-review-item">
                                    <div class="info-column">
