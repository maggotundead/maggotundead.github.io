...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://demo-lookincasino.com/css/actions-lottery.css">
...
<body>
    ...
    <div class="wrapper">
        ...
        <main class="content">
            ...
            <section class="block block-banner-slider text" style="background-image: url('https://demo-lookincasino.com/img/casino-lottery-banner.jpg');">
                <div class="wrap">
                    <div class="banner-slider" id="banner-slider">
                        <div class="slide">
                            <div class="slide-content">
                                <div class="slide-title">
                                    Розыгрыши казино Eclipse
                                </div>
                                ...
                                <div class="slide-descr">
                                    <p>
                                        26 октября в казино Eclipse! <br>
                                        Главный приз - автомобиль Audi A7 Sportback и $20 000. <br>
                                        В розыграше участвуют игроки на слот-автоматах и столах - обладатели карт статуса Gold. Играйте в Казино Eclipse, накапливайте билеты и выигрывайте!
                                    </p>
                                </div>
            ...
            <section class="block block-best-offers">
                <div class="wrap">
                    <div class="block-title">
                        Лучшие розыгрыши
                    </div>
                    <div class="best-offers-outer">
                        <div class="best-offers slider-top-controls" id="best-offers-slider">
                            <div class="slide">
                                <div class="best-offer-item">
                                    <div class="photo" style="background-image: url('https://demo-lookincasino.com/img/casino-review.jpg');">
                                    </div>
                                    <div class="info">
                                        <div class="label">
                                            Розыгрыши
                                        ...
                                        <div class="title">
                                            Розыгрыш «Cosmic Eclipse» от Eclipse Casino
                                        </div>
                                        <div class="descr">
                                            Приняв участие в акции “Cosmic Eclipse Free Spins” от казино Eclipse игрок на протяжении 4-х дней сможет получать...
                                        </div>
                                        <a href="https://demo-lookincasino.com/lottery-item/" class="button white-bluelight link">
                                            Подробнее
                                        </a>
                                    </div>
                                </div>
            ...
            <section class="block block-search-form">
                <div class="wrap">
                    <div class="search-form-container">
                        <div class="search-form-head">
                            <div class="head-text">
                                <div class="search-form-title">
                                    Поиск розыгрышей казино
                                </div>
                                <div class="search-form-descr">
                                    Для поиска розыгрышей, введите необходимые параметры
                                </div>
                            </div>
                        ...
                        <form class="search-form lottery-advanced-search-form">
                            ...
                            <div class="select-group gambling-type">
                                <select class="select">
                                    <option selected="selected" disabled="disabled">
                                        Игорное заведение
                                    </option>
                                    ...
                                    <option value="Покер клуб">
                                        Покер клуб
                                    </option>
                                    <option value="Ставки на спорт">
                                        Ставки на спорт
                                    </option>
                                </select>
                            </div>
            ...
            <section class="block-actions-lottery">
                <div class="wrap">

                    <div class="gambling-column gambling-actions-column">

                        <div class="gambling-ratings-head">
                            <div class="block-title">
                                Список розыгрышей
                            </div>
                        ...
                        <div class="gambling-items gambling-actions">
                            <div class="gambling-item">
                                <div class="photo" style="background-image: url('https://demo-lookincasino.com/img/casino-review.jpg');">
                                    <button class="zoom-photo"></button>
                                </div>
                                <div class="info">
                                    <div class="descr-column">
                                        ...
                                        <div class="descr">
                                            Приняв участие в розыгрыше “Cosmic Eclipse Free Spins” от казино BetSafe игрок на протяжении 4-х дней сможет получать....
                                        </div>
                                        <div class="buttons">
                                            <a href="https://demo-lookincasino.com/lottery-item/" class="button blue rating-casino-link">
                                                Подробнее
                                            </a>
                                            <a href="https://demo-lookincasino.com/individual-casino/" class="button grey review-casino-link">
                                                Обзор казино
                                            </a>
                                        </div>
                                    </div>
                                            ...
                                            <div class="rates">
                                                <div class="rate-and-stars">
                                                    ...
                                                    <div class="item-stars stars-rate-group">
                                                        ...
                                                        <div class="stars-rate yellow stars-rate-current" style="width: calc((4.6 * 12px) + (4 * 9px))">
                                                            <div class="star"></div>
                                                            <div class="star"></div>
                                                            <div class="star"></div>
                                                            <div class="star"></div>
                                            ...
                                            <div class="rates">
                                                <div class="rate-and-stars">
                                                    ...
                                                    <div class="item-stars stars-rate-group">
                                                        ...
                                                        <div class="stars-rate yellow stars-rate-current" style="width: calc((4.0 * 12px) + (4 * 9px))">
                                                            <div class="star"></div>
                                                            <div class="star"></div>
                                                            <div class="star"></div>
                                                            <div class="star"></div>
                            ...
                            <div class="gambling-item">
                                ...
                                <div class="info">
                                    <div class="descr-column">
                                        <div class="title">
                                            Розыгрыш «Cosmic Казино» <br>от Казино 4
                                        </div>
                                        <div class="date">
                                            19 мая 2019
                                        </div>
