...
<head>
    <meta charset="UTF-8">
    <title>Одна статья новостей</title>
...
<body class="">
    ...
    <div class="wrapper">
        ...
        <main class="content">
            ...
            <section class="block block-banner-slider text" style="background-image: url('https://demo-lookincasino.com/img/news-banner.jpg');">
                <div class="wrap">
                        ...
                        <div class="slide">
                            <div class="slide-content">
                                ...
                                <div class="slide-descr">
                                    <p>
                                       С 1 октября по 7 октября, каждый день, <br>
                                       на сцене Eclipse Casino проходят концерты <br>
                                       звезд российской эстрады и другие <br>
                                       мероприятия..
                                    </p>
                                </div>

                                <a href="https://demo-lookincasino.com/article/" class="button transparent slide-link">
                                    Подробнее
                                </a>
                            </div>
                        </div>
            ...
            <section class="block block-single-article-news">
                <div class="wrap">
                    <div class="news-column">
                        <div class="single-news-item">
                            <div class="article-banner" style="background-image: url('https://demo-lookincasino.com/img/news-dummy.jpg');">
                            ...
                            <div class="article-description">
                                В комфортной и непринужденной атмосфере двухуровневого Главного зала гостей ждут бесчисленные увлекательные азартные игры. Среди них: Американская Рулетка, Блек Джек, Пунто- Банко, 10 разновидностей Покера, а также широкий выбор популярных игровых автоматов. Кроме того, мы предлагаем три уникальных современных VIP-зала, каждый из которых демонстрирует высокий уровень индивидуальности и роскоши, предлагая панорамные виды на море. В Казино ECLIPSE работает собственный Покерный Клуб. Гостей ждут поистине незабываемые ощущения!
                                <br>
                                
                                <img src="https://demo-lookincasino.com/img/news-dummy.jpg" align="right" >
                                <br>
                                В утонченной обстановке казино Eclipse гостей ожидает 35 столов для игры в Американскую Рулетку, Блек Джек, Пунто-Банко и 10 разновидностей покера: трёх карточный, два вида шести карточных, два вида Русских, Оазис, Нуово, Техасский холдем, Алтимейт Техас и Мульти покер.
                                <br>
                                <br>
                                Еще карту или хватит? Решать вам, когда вы садитесь за наши столы для блэкджек. Эта знаменитая игра, также известная как «Двадцать одно», является одной из самых популярных и широко распространенных игр в казино по всему миру. Целью является достижение наивысшего возможного результата, превышающего результат крупье, но не больше 21 очка.
                                
                            </div>
                            <div class="article-share">
                                <div class="share-status-item">
                                    <img src="https://demo-lookincasino.com/img/icon-action-1.png">
                                    <span>1.2K</span>
                                </div>
                                <div class="share-status-item">
                                    <img src="https://demo-lookincasino.com/img/icon-action-2.png">
                                    <span>185</span>
                                </div>
                                <div class="share-status-item">
                                    <img src="https://demo-lookincasino.com/img/icon-action-3.png">
                                    <span>2.4K</span>
                                </div>
                                <div class="share-status-item">
                                    <img src="https://demo-lookincasino.com/img/icon-action-4.png">
                                    <span>952</span>
                                </div>
                                <div class="share-status-item">
                                    <img src="https://demo-lookincasino.com/img/icon-action-5.png">
                                    <span>10</span>
                                </div>
                                <div class="share-status-item">
                                    <img src="https://demo-lookincasino.com/img/icon-action-6.png">
                                    <span>48</span>
                                </div>
                                <a href="/" class="chat-link">
                                    <span class="comments-value">23</span>
                    ...
                    <div class="chat-column">
                        <div class="all-chats active">
                            ...
                            <div class="chat-list">
                                <div class="chat-list-item">
                                    <a href="/" class="left-column single-chat-link">
                                        <div class="title">
                                            Маленький заголовок <br>
                                            не главной новости
                                        </div>
                                        <div class="date">
                                            22 августа 2015
                                    ...
                                    <div class="right-column">
                                        <button class="notification active"></button>
                                        <div class="comments">
                                            1
                                        </div>
                                    </div>
                        ...
                        <div class="single-chat">
                            <div class="head">
                                ...
                                <div class="title">
                                    Eclipse Poker Tour в сентябре: 22 турнира, 3 TV-трансляции...
                                </div>
                                <button class="notification"></button>
                            </div>
                            <div class="chat-body">
                                <div class="chat-messages">
                                    <div class="comment-item">
                                        <div class="text-column">
                                            ...
                                            <div class="message-text">
                                                Текст комментария человека по Имени и Фамилии указанной сверху над этим сообщением
                                            </div>
                                        </div>
                                        <div class="voting-column">
                                            <div class="voting-group up">
                                                <button class="voting-button"></button>
                                                <div class="voting-value">
                                                    4.2к
                                                </div>
                                            </div>
                                            <div class="voting-group down">
                                                <button class="voting-button"></button>
                                                <div class="voting-value">
                                                    1.2к
                                                </div>
                                        ...
                                        <div class="bottom-controls">
                                            ...
                                            <button class="comment-complaint">
                                                Жалоба
                                            </button>
                                    ...
                                    <div class="comment-item">
                                        <div class="text-column">
                                            ...
                                            <div class="reply-message-text">
                                                Текст комментария человека на который дается ответ в сообщении ниже
                                            </div>
                                            <div class="message-text">
                                                Текст комментария человека по Имени и Фамилии указанной сверху над этим сообщением
                                            </div>
                                    ...
                                    <div class="comment-item">
                                        ...
                                        <div class="voting-column">
                                            <div class="voting-group up empty">
                                                <button class="voting-button"></button>
                                                <div class="voting-value">
                                                    0
                                                </div>
                                            </div>
                                            <div class="voting-group down empty">
                                                <button class="voting-button"></button>
                                                <div class="voting-value">
                                                    0
                                                </div>
                                ...
                                <div class="chat-send">
                                    <textarea placeholder="Напишите что-нибудь..." class="send-input"></textarea>
                    ...
                    <aside class="aside-column">
                        <div class="aside-group">
                            <div class="game-banner half" style="background-image: url('https://demo-lookincasino.com/img/game-full-banner.png');">
                                <div class="title">
                                    <span>Игра</span>
                                    высшей пробы
                                </div>
                        ...
                        <div class="aside-group">
                            ...
                            <div class="short-news-comments-nophotos">
                                <a href="https://demo-lookincasino.com/article/" class="short-news-item">
                                    <div class="text">
                                        <div class="title">
                                            Маленький заголовок <br>
                                            не главной новости
            ...
            <section class="block block-now-reading">
                <div class="wrap">
                    <div class="block-title">
                        Сейчас читают
                    </div>
                    <div class="four-slides-slider slider-top-controls now-reading-slider">
                        <div class="slide">
                            <div class="news-item">
                                ...
                                <div class="info">
                                    <div class="title">
                                        Заголовок про ошеломительный выигрыш человека
                                    </div>
                                    <div class="date">
                                        19 мая 2019
                                    </div>
                                    ...
                                    <a href="https://demo-lookincasino.com/article/" class="link">
                                        Читать далее ›
                                    </a>
                                </div>
                            </div>
