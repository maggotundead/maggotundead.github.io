...
// gulp.task('default', gulp.series(gulpServer, gulpJs, gulpSass));
...
gulp.task('watch', gulp.series('sass', 'js', 'browser-sync', function(done) {
    gulp.watch(['./app/**.html', './resources/sass/**/*.scss', './resources/js/**/*.js'], gulp.series('sass', 'js'));
