...
<body class="">
    ...
    <div class="wrapper">
        ...
        <main class="content">
            ...
            <section class="block block-banner-slider text" style="background-image: url('https://demo-lookincasino.com/img/poker-banner.jpg');">
                <div class="wrap">
                    <div class="banner-slider" id="banner-slider">
                        <div class="slide">
                            <div class="slide-content">
                                ...
                                <div class="slide-title-descr beforeline">
                                    Eclipse Poker Club
                                </div>
                                <div class="slide-descr">
                                    Eclipse Poker Club - это идеальная возможность <br>
                                    насладиться конкурентным покером в Батуми <br>
                                    в роскошной обстановке с несколькими ставками <br>и дружеской атмосферой
                                </div>
            ...
            <section class="block block-poker-clubs-news">
                <div class="wrap">
                    <div class="block-title">
                        Новости покера
                    </div>
                    <div class="poker-clubs-news">
                        <div class="left-column primary-news">
                            <div class="poker-clubs-news-slider" id="poker-clubs-news-slider">
                                <div class="slide">
                        ...
                        <div class="right-column aside-column">
                        ...
                        <div class="search-form-head">
                            <div class="head-text">
                                ...
                                <div class="search-form-descr">
                                    Хотите поиграть в покер на деньги или поучаствовать в покерном турнире? Наш сервис предоставит вам <br>
                                    обширный список офлайн покер клубов в любой точке мира с расписанием кэш­игр и турниров. Для выбора наиболее <br>
                                    подходящего покер рума достаточно задать интересующий вас регион и мы подберем варианты для вас.
                                </div>
                            </div>
            ...
            <section class="block block-poker-clubs-world-map">
                <div class="wrap">
                    <div class="block-title">
                        Международный поиск покерных клубов
                    </div>
                            ...
                            <div class="map-item size-1 blue" style="left: 49.8%; top: 47%; ">
                                ...
                                <div class="poker-clubs-popup">
                                    ...
                                    <div class="popup-title">
                                        Доступные покер клубы в Грузии
                                    </div>
                                    <div class="poker-clubs-list">
                                        <div class="poker-club-item">
                                            ...
                                            <div class="contacts">
                                                <address class="address">
                                                    Страна, длинное название города, длинная улица покер клуба
                                                </address>
                                        ...
                                        <div class="poker-club-item">
                                            ...
                                            <button class="button white-bluelight poker-club-link">
                                                Обзор
                                            </button>
                                        </div>
                                    </div>
                                    <div class="poker-clubs-recommend">
                                        <div class="poker-club-item">
                                            ...
                                            <a href="/" class="button orange poker-club-link" target="_blank">
                                                Обзор
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <div class="map-wrapper">
                            ...
                            <div class="poker-clubs-recommend">
                                <div class="recommend-item">
                                    ...
                                    <div class="center-column">
                                        <address class="address">
                                            ул. Леха и Марии Качинских 1, <br>  Батуми, Грузия.
                                        </address>
                                        <a href="tel:" class="phone">
                                            + 995 557 110 000
                                        </a>
                                    </div>
                                    <button class="button white-orange recommend-link">
                                        Обзор
                                    </button>
                        ...
                        <div class="poker-clubs-map" id="poker-clubs-map"></div>
                    </div>
                </div>
            </section>
            ...
            <section class="block block-best-poker-clubs">
                <div class="wrap">
                    <div class="block-title">
                        Лучшие покерные клубы
                    </div>
                    <div class="poker-clubs-slider-outer">
                        <div class="poker-clubs-slider slider-top-controls" id="poker-clubs-slider">
                            <div class="slide">
                                <div class="casino-item" style="background-image: url('https://demo-lookincasino.com/img/news-dummy.jpg');">
                                    <div class="casino-item-inner">
                                        ...
                                        <a href="/" class="button transparent casino-link">
                                            Подробнее
                                        </a>
                                    </div>
                                </div>
            ...
            <section class="block block-tournament-items-map">
                <div class="wrap">
                    <div class="tournament-items-list-outer">
                        <div class="block-title">
                            Текущие и ближайшие серии турниров
                        </div>
                        <div class="map-control">
                            <div class="map-control-title">
                                Найдено 4 серии турниров
                            </div>
                            <div class="map-control-buttons">
                                <div class="select-group country">
                                    <select class="select">
                                ...
                                <div class="date-input-group">
                                    ...
                                    <div class="date-input-dropdown">
                                        <input type="text" class="date-range" hidden="hidden" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="tournament-items-list">
                            <div class="tournament-item">
                                <div class="item-column">
                                    ...
                                    <div class="location">
                                        <img src="https://demo-lookincasino.com/img/flag-georgia.jpg">
                                        <div class="location-text">
                                            <span class="country">Грузия</span>
                                            <span class="city">Батуми</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="item-column">
                                    ...
                                    <div class="descr">
                                        Роскошная обстановка Eclipse Poker Club, разнообразные ставки и дружеская атмосфера. Идеальный способ получить удовольствие от грандиозного турнира
                                    </div>
                                    <div class="buttons">
                                        <a href="/" class="button blue tournament-item-link">
                                            Принять участие
                                        </a>
                            ...
                            <div class="tournament-item">
                                <div class="item-column">
                                    ...
                                    <div class="location">
                                        <img src="https://demo-lookincasino.com/img/flag-bulgaria.jpg">
                                        <div class="location-text">
                                            <span class="country">Страна 1</span>
                                            <span class="city">Город 1</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="item-column">
                                    ...
                                    <div class="descr">
                                        Роскошная обстановка Казино 1, разнообразные ставки и дружеская атмосфера. Идеальный способ получить удовольствие от грандиозного турнира
                                    </div>
                                    <div class="buttons">
                                        <a href="/" class="button blue tournament-item-link">
                                            Принять участие
                            ...
                            <div class="tournament-item">
                                <div class="item-column">
                                    ...
                                    <div class="location">
                                        <img src="https://demo-lookincasino.com/img/flag-bulgaria.jpg">
                                        <div class="location-text">
                                            <span class="country">Страна 2</span>
                                            <span class="city">Город 2</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="item-column">
                                    ...
                                    <div class="descr">
                                        Роскошная обстановка Казино 2, разнообразные ставки и дружеская атмосфера. Идеальный способ получить удовольствие от грандиозного турнира
                                    </div>
                                    <div class="buttons">
                                        <a href="/" class="button blue tournament-item-link">
                                            Принять участие
                            ...
                            <div class="tournament-item">
                                <div class="item-column">
                                    ...
                                    <div class="location">
                                        <img src="https://demo-lookincasino.com/img/flag-bulgaria.jpg">
                                        <div class="location-text">
                                            <span class="country">Страна 3</span>
                                            <span class="city">Город 3</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="item-column">
                                    <div class="title">
                                        Второй по значимости турнир от Casino 3
                                    </div>
                                    <div class="date">
                                        19сентября - 28 октября 2019
                                    </div>
                                    <div class="descr">
                                        Роскошная обстановка Казино 3, разнообразные ставки и дружеская атмосфера. Идеальный способ получить удовольствие от грандиозного турнира
                                    </div>
                                    <div class="buttons">
                                        <a href="/" class="button blue tournament-item-link">
                                            Принять участие
                            ...
                            <div class="tournament-item">
                                <div class="item-column">
                                    ...
                                    <div class="location">
                                        <img src="https://demo-lookincasino.com/img/flag-bulgaria.jpg">
                                        <div class="location-text">
                                            <span class="country">Страна 4</span>
                                            <span class="city">Город 4</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="item-column">
                                    <div class="title">
                                        Второй по значимости турнир от Casino 4
                                    </div>
                                    <div class="date">
                                        19сентября - 28 октября 2019
                                    </div>
                                    <div class="descr">
                                        Роскошная обстановка Казино 4, разнообразные ставки и дружеская атмосфера. Идеальный способ получить удовольствие от грандиозного турнира
                                    </div>
                                    <div class="buttons">
                                        <a href="/" class="button blue tournament-item-link">
                                            Принять участие
                    ...
                    <!-- Карта, запрограмированная через Google Maps Api и массив данных -->
                    <div class="tournament-items-map" id="tournament-items-map"></div>
                </div>
            </section>
