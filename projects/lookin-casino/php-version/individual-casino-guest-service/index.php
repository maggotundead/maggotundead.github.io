...
<head>
    <meta charset="UTF-8">
    <title>Индивидуальная страница казино | Гостевой сервис</title>
...
<body class="">
    ...
    <div class="wrapper">
        ...
        <main class="content">
            ...
            <section class="block block-guest-service">
                <div class="wrap">
                    <div class="block-title">
                        Гостевой сервис
                    </div>
                    <div class="block-title-descr">
                        Отправляйтесь сами или с друзьями. Выберите туристический пакет, который наилучшим образом соответствует вашим потребностям.
                    </div>
                    <div class="guest-service">
                        <div class="service-params">
                            <div class="param-title">
                                Покер, блэкджек, мин.ставка
                            </div>
                            <div class="param-title">
                                Рулетка, всё в этой зоне, мин.ставка
                            </div>
                            <div class="param-title">
                                Игровые автоматы, за спин, мин. ставка
                            </div>
                            <div class="param-title">
                                Время за игровым столом
                            </div>
                            <div class="param-title">
                                Могут быть предложены специальные условия
                            </div>
                            <div class="param-title">
                                Авиабилет
                            </div>
                        ...
                        <div class="service-deposits">
                            <div class="deposit-item">
                                ...
                                <div class="param-values">
                                    ...
                                    <div class="param-value">
                                        <div class="item-stars stars-rate-group">
                                            <div class="stars-rate bluelight">
                                                <div class="star"></div>
                                                <div class="star"></div>
                                                <div class="star"></div>
                                                <div class="star"></div>
                                ...
                                <a href="/" class="button blue order-guest-service">
                                    Заказать
                                </a>
                            </div>
                            <div class="deposit-item">
            ...
            <section class="block block-guest-placement">
                <div class="wrap">
                    <div class="block-title">
                        Размещение
                    </div>
                        ...
                        <div class="hotel-item">
                            <div class="hotel-info">
                                <div class="hotel-about">
                                    ...
                                    <!-- <a href="/" class="wishlist-link added"> -->
                                        Добавить в избранное
                                    </a>
                                    <div class="descr">
                                        Комфортные номера, первоклассное обслуживание, спа-салон и собственный торговый центр — то, почему Eclipse Hotel оказался в списке рекомендаций Казино Eclipse.
                                    </div>
                                </div>
                        ...
                        <div class="hotel-item">
                            <div class="hotel-info">
                                <div class="hotel-about">
                                    ...
                                    <div class="descr">
                                        Наслаждайтесь великолепным видом на море из комфортабельных апартаментов с кондиционером, кухней, ванной комнатой и гостиной с телевизором с плоским экраном.
                                    </div>
                                </div>
                                <div class="hotel-contacts">
                                    <div class="title">
            ...
            <section class="block block-how-it-works">
                <div class="wrap">
                    <div class="block-title">
                        Как это работает
                    </div>
                    <div class="block-title-descr">
                        Отвлекитесь от городской суеты и получите максимум впечатлений и эмоций без лишних затрат и потерь драгоценного времени!
                    </div>
                    <div class="order-steps">
                        <div class="step-item">
                            <div class="icon">
                                <img src="https://demo-lookincasino.com/img/order-step-1.png">
                            </div>
                            <div class="title">
                                Выберите <br>
                                вариант тура <br>
                        ...
                        <div class="step-item">
                            <div class="icon">
                                <img src="https://demo-lookincasino.com/img/order-step-2.png">
                            </div>
                            <div class="title">
                                Пришлите нам <br>
                                данные вашего <br>
                        ...
                        <div class="step-item">
                            <div class="icon">
                                <img src="https://demo-lookincasino.com/img/order-step-3.png">
                            </div>
                            <div class="title">
                                Забронируйте отель <br>
                                в соответствии <br> 
                                с выбранным туром
                            </div>
                        </div>
                        <div class="step-item">
                            <div class="icon">
                                <img src="https://demo-lookincasino.com/img/order-step-4.png">
                            </div>
                            <div class="title">
                                Мы встретим вас <br>
                                в аэропорту <br>
                        ...
                        <div class="step-item">
                            <div class="icon">
                                <img src="https://demo-lookincasino.com/img/order-step-5.png">
                            </div>
                            <div class="title">
                                Приходите в казино, <br>
                                вносите депозит <br>
                                и играйте в соответствии <br>
                                с условиями тура
                            </div>
                        </div>
                        <div class="step-item">
                            <div class="icon">
                                <img src="https://demo-lookincasino.com/img/order-step-6.png">
                            </div>
                            <div class="title">
                                Если игровые условия тура выполнены, расходы на перелет, трансфер, проживание и питание, частично или полностью, — за наш счет
                            </div>
                        </div>
                    </div>
                    <div class="order-annotation">
                        Задайте свои вопросы менеджеру по телефону <span>8-800-400-00-00</span>
                    </div>
                </div>
            </section>
            

            <!-- <section class="block block-single-casino-restaurant">
                <div class="wrap">
                    ...
                    <div class="restaurant-contacts block-services-order">
                    ...
                    <div class="restaurant-general-info">
                        ...
                        <div class="list general-info">
                            <div class="left-column restaurant-rate">
                            ...
                            <div class="right-column restaurant-certificate">
                                <div class="restaurant-certificate-icon">
                                    <img src="https://demo-lookincasino.com/img/icon-certificate-bluelight.png">
                                </div>
                                <div class="restaurant-certificate-title">
                                    Сертификат <br>
                                    качества
                                </div>
                            </div>
                    ...
                    <div class="restaurant-about">
                        ...
                        <div class="about-links">
                            <a href="/" class="about-link menu">
                                Показать меню
                            </a>
                            <a href="/" class="about-link bar">
                                Карта бара
                            </a>
                            <a href="/" class="about-link shisha">
                                Кальяны
                            </a>
                        </div>
                        <div class="descr">
                            В уникальной атмосфере ресторана Eclipse гурманов ждут незабываемые впечатления от изысканнейших блюд.Дизайн ресторана основан на оригинальной концепции, навеянной бездонной синевой Черного моря и золотыми лучами грузинского солнца. В этой восхитительной обстановке вам подадут изысканные блюда, которые превзойдут все ваши ожидания, ведь повара отобрали все лучшее из современной высокой кухни Грузии, Турции, Японии и Европы.
                        </div>
                    ...
                    <div class="game-banner" style="background-image: url('https://demo-lookincasino.com/img/game-half-banner.png');">
                        <div class="title">
                            <span>Игра</span>
                            высшей пробы
                        </div>
