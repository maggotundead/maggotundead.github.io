...
<head>
    <meta charset="UTF-8">
    <title>Индивидуальная страница казино | Ставки на спорт</title>
...
<body class="">
    ...
    <div class="wrapper">
        ...
        <main class="content">
            ...
            <section class="block block-single-gambling-item">
                <div class="wrap">
                    <div class="info-contacts-column">
                        <div class="gambling-item-header">
                            <div class="header-top">
                            ...
                            <div class="header-bottom">
                                ...
                                <div class="stars-rank">
                                    <div class="item-stars stars-rate-group">
                                        ...
                                        <div class="stars-rate yellow stars-rate-current" style="width: calc((4.6 * 16px) + (4 * 12px))">
                                            <div class="star"></div>
                                            <div class="star"></div>
                                            <div class="star"></div>
                                            <div class="star"></div>
                                    ...
                                    <a href="individual-casino-reviews.html" class="reviews-link">
                        ...
                        <div class="gambling-item-order block-services-order">
                        ...
                        <div class="gambling-item-contacts">
                    ...
                    <div class="about-gallery-column">
                        <div class="about-club">
                            <div class="about-column">
                                <div class="block-title">
                                    <!-- О Покерном Клубе ECLIPSE -->
                                    О Букмекерском клубе ECLIPSE
                                </div>
                                <div class="about-text">
                                    <!-- <p>
                                        Мы предлагаем множество способов насладиться острыми ощущениями в покере, удовлетворяя всем вкусам и уровням игры – от No Limit Texas Hold'em до Pot Limit Omaha с блайндами от $1/3 и выше. Конкурентный покер в уникальной и непринужденной обстановке – это идеальный способ познакомиться с новыми игроками и завести друзей. Практикуйте и улучшайте свои навыки в играх с низкими ставками, а затем рискуйте и выигрывайте, играя с повышенными ставками. К вашим услугам 5 карточных столов покерного клуба Eclipse. Крупный накопительный Bad Beat Jackpot ждёт именно вас.
                                    </p> -->
                                    <p>
                                        Сделайте ставку, устройтесь удобнее и окунитесьв особую атмосферу спорта в букмекерском клубе Eclipse.
                                    </p>
                                    <p>
                                        Для любителей спорта Букмекерский клуб Eclipse предоставит отличный выбор матчей, наличие экспресс-линии с самыми высокими коэффициентами и лимитами в Грузии, быстрые гарантированные выплаты, высокий уровень сервиса, круглосуточное обслуживание и комфортную зону с большими HD-экранами для просмотра самых интересных и захватывающих спортивных событий в мире!
                                    </p>
                                </div>
                            </div>
                            <div class="terms-column">
                                ...
                                <a href="/" class="terms-link">
                                    Правила приема ставок и выплаты выигрышей
                                </a>
                                <a href="/" class="terms-link">
                        ...
                        <div class="gambling-item-gallery">
            ...
            <section class="block block-gambling-item-news single-gambling-item-news">
                <div class="wrap">
                    <div class="block-title">
                        Новости ставок на спорт
                    </div>
                    <div class="gambling-item-news">
                        <div class="left-column primary-news">
                            <div class="gambling-item-news-slider" id="gambling-item-news-slider">
                                <div class="slide">
