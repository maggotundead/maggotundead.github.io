...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="https://demo-lookincasino.com/css/poker.css"> -->
    <link rel="stylesheet" type="text/css" href="https://demo-lookincasino.com/css/bets.css">
...
<body class="">
    ...
    <div class="wrapper">
        ...
        <main class="content">
            ...
            <section class="block block-banner-slider text" style="background-image: url('https://demo-lookincasino.com/img/bets-banner.jpg');">
                <div class="wrap">
                    <div class="banner-slider" id="banner-slider">
                        <div class="slide">
                            <div class="slide-content">
                                <div class="slide-title">
                                    Букмекерский клуб Eclipse
                                </div>
                                <div class="slide-title-descr">
                                    Бонус приветствия казино Eclipse до $1000
                                </div>
                                <div class="slide-descr">
                                    Сделайте ставку, устройтесь удобнее и окунитесь <br>
                                    в особую атмосферу спорта в букмекерском <br>клубе Eclipse
                                </div>
            ...
            <section class="block-sport-events">
                <div class="wrap">
                    <div class="sport-events">

                        <div class="events-selectors">
                            <div class="events-type-selectors">
                                ...
                                <div class="events-groups-links">
                                    <div class="event-type-group">
                                        <div class="type-values">
                                            <a href="/" class="type-value">
                                                Футбол
                                            </a>
                                            <a href="/" class="type-value">
                                                Хоккей
                                    ...
                                    <div class="event-time-group">
                                        <div class="time-values">
                                            <label class="time-value">
                                                <input type="radio" name="time-value" hidden="hidden" class="radio-default" checked="checked">
                                            ...
                                            <label class="time-value">
                                                <input type="radio" name="time-value" hidden="hidden" class="radio-default">
                                                <span class="radio-custom"></span>
                                                <span class="radio-text">
                                                    Сегодня 43
                                                </span>
                                        ...
                                        <label class="important-trigger">
                                            <span class="checkbox-text">
                                                Важные
                                            </span>
                                            <input type="checkbox" name=""
                                            hidden="hidden" checked="checked" class="checkbox-default">
                                            <span class="checkbox-custom"></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="events-time-selectors">
                                <a href="/" class="events-link past-events-link">
                                    Предыдущие события
                                </a>
                                <div class="today-events">
                                    События сегодня
                                </div>
                                <a href="/" class="events-link future-events-link">
                                    Следующие события
                                </a>
                            </div>
                        </div>
                        <div class="events-groups">
                            <div class="events-group football">
                                <div class="event-group-title">
                                    Россия - Премьер-Лига. 9-й тур
                                </div>
                                <div class="event-group-items">
                                    <div class="event-group-item">
                                        <div class="info-column item-type-column">
                                            <div class="item-type">
                                                Футбол
                                            </div>
                                            <div class="item-date">
                                        ...
                                        <div class="info-column players-column">
                                            <div class="player">
                                                <div class="player-title">
                                                    Арсенал Тула
                                                </div>
                                                <div class="player-logo">
                                                    <img src="https://demo-lookincasino.com/img/player-logo-1.png">
                                                </div>
                                            </div>
                                            <div class="player">
                                                <div class="player-title">
                                                ...
                                                <div class="player-logo">
                                                    <img src="https://demo-lookincasino.com/img/player-logo-2.png">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a class="show-more-events">
                                    Показать больше
                                </a>
                            </div>
                            <div class="events-group hockey">
                                <div class="event-group-title">
                                    ...
                                    <div class="event-group-item">
                                        ...
                                        <div class="info-column players-column">
                                            ...
                                            <div class="player">
                                                ...
                                                <div class="player-logo">
                                                    <img src="https://demo-lookincasino.com/img/player-logo-3.png">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="events-group basketball">
                                <div class="event-group-title">
                                    ЧМ-2019 (м). 1/2 финала
                                </div>
                                <div class="event-group-items">
                                    <div class="event-group-item">
                                        <div class="info-column item-type-column">
                            ...
                            <!-- <div class="events-group volleyball">
                                <div class="event-group-title">
                                    ЧМ-2019 (м). 1/2 финала
                                </div>
                                <div class="event-group-items">
                            ...
                            <div class="events-group biatlon">
                                <div class="event-group-title">
                                    ЧМ-2019 (м). 1/2 финала
                                </div>
                                <div class="event-group-items">
                            ...
                            <div class="events-group formula">
                                <div class="event-group-title">
                                    ЧМ-2019 (м). 1/2 финала
                                </div>
                                <div class="event-group-items">
                            ...
                            <div class="my-tournaments-list">
                                ...
                                <div class="tournaments-items">
                                    <div class="tournament-item">
                                        Россия — Высшая <br>
                                        Премьер-Лига 
                                        <button class="delete-tournament-button"></button>
                                    </div>
                                    <div class="tournament-item">
                                        Россия — Высшая <br>
                                        Премьер-Лига 
                                ...
                                <form class="search-form">
                                    <input type="text" name="" placeholder="Найти турнир" class="search-input">
                        ...
                        <!-- <div class="aside-group">
                            ...
                            <div class="sport-news">
                                <a href="/" class="news-item">
                                    <span class="title">
                                        Украина стартовала на ЧЕ-2019 по волейболу с исторической победы (Видео)
                                    </span>
                                    <span class="time">
                                        19:21
                                    </span>
            ...
            <section class="block block-sport-bets-news single-sport-bets-news">
                <div class="wrap">
                    <div class="block-title">
                        Новости спорта
                    </div>
                    <div class="sport-bets-news">
                        <div class="left-column primary-news">
                            <div class="sport-bets-news-slider" id="sport-bets-news-slider">
                                <div class="slide">
                                    <a href="/" class="news-item" style="background-image: url('https://demo-lookincasino.com/img/news-dummy.jpg');">
                                        <div class="overlay"></div>
                                        <div class="title">
                                            Заголовок первого <br>события
                                        </div>
                                        <div class="date">
                                            Август 22, 2019
                                        </div>
                        ...
                        <div class="center-column secondary-news">
                            <a href="/" class="news-item" style="background-image: url('https://demo-lookincasino.com/img/news-dummy.jpg');">
                                <div class="overlay"></div>
                                <div class="title">
                                    Заголовок второго <br>
                                    события
                                </div>
                                <div class="date">
                                    Август 22, 2019
                        ...
                        <div class="right-column short-news">
            ...
            <section class="block block-forecasters">
                <div class="wrap">
                    <div class="block-head">
                        <div class="block-title">
                            Ставки на спорт от команды прогнозистов “Lookin Casino”
                        </div>
                        <div class="block-title-descr">
                            Наша команда профессионалов анализирует более 1000 матчей каждый месяц и предлагает точные прогнозы на все популярные виды соревнований. Ни одно из крупных и значимых событий в мировом спорте не остается без внимания наших экспертов. На этой странице Вы найдете прогнозы на спорт , которые помогут Вам принять правильное решение при выборе Вашей ставки
                        </div>
                    </div>
                    <div class="forecasters-outer slider-top-controls">
                        <div class="slider-controls"></div>
                        <div class="forecasters" id="forecasters-slider">
                            <div class="forecaster-item">
                        ...
                        <div class="forecasters-buttons">
                            <a href="/" class="button white join-link">
                                Стать прогнозистом
                            </a>
                            <a href="/" class="button all-forecasters-link">
                                Смотреть всех
                            </a>
                        </div>
                    </div>
            ...
            <section class="block block-forecast">
                <div class="wrap">
                    ...
                    <div class="forecast-outer">
                        <div class="forecast slider-top-controls" id="forecast-slider">
                            <div class="slide">
                                <div class="forecast-item">
                                    <div class="head" style="background-image: url('https://demo-lookincasino.com/img/news-dummy.jpg');">
                                        <div class="team home">
                                            <img src="https://demo-lookincasino.com/img/team-logo-1.png">
                                        </div>
                                        <div class="session">
                                            <div class="date">
                                                22 августа 2019
                                        ...
                                        <div class="team visitor">
                                            <img src="https://demo-lookincasino.com/img/team-logo-2.png">
                                        </div>
                                    </div>
                                    <div class="body">
                                        <div class="title">
                                            Прогноз на шикарный матч по футболу Россия / ПФЛ 
                                        </div>
                                        <div class="date-time">
                                            15:50 - Август 22, 2015
                                        </div>
                                        <div class="commands">
                                            <div class="command">0 Sibir Novosibirsk</div>
                                            <div cla="command">0 Dynamo Barnaul</div>
                                        </div>
                                        <div class="coefficients">
                                            <div class="coefficient">1.47</div>
                                            <div class="coefficient">2.0</div>
                                            <div class="coefficient">2.53</div>
                                        </div>
                                    </div>
                                    <a href="/" class="button forecast-link">
                                        Открыть прогноз
                                    </a>
                                </div>
                            </div>
            ...
            <section class="block block-banner">
                <div class="wrap">
                    <div class="banner" style="background-image: url('https://demo-lookincasino.com/img/bets-block-banner.jpg');">
                        <span class="banner-title">
                            ИГРА высшей пробы
                        </span>
                        <a href="/" class="button transparent banner-link">
                            Подробнее
                        </a>
                    </div>
                </div>
