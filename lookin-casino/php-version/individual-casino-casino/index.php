...
<head>
    <meta charset="UTF-8">
    <title>Индивидуальная страница казино | Казино</title>
...
<body class="">
    ...
    <div class="wrapper">
        ...
        <main class="content">
            ...
            <section class="blobk block-single-casino-details">
                <div class="wrap">
                    <div class="casino-header">
                        ...
                        <div class="header-column">
                            <div class="item-stars stars-rate-group">
                                ...
                                <div class="stars-rate yellow stars-rate-current" style="width: calc((4.6 * 17px) + (4 * 10px))">
                                    <div class="star"></div>
                                    <div class="star"></div>
                                    <div class="star"></div>
                                    <div class="star"></div>
                        ...
                        <div class="header-column">
                            ...
                            <!-- when added <a href="/" class="wishlist-link added"> -->
                                Выбор редакции
                            </a>
                        </div>
                    </div>
                    <div class="casino-gallery">
                        <img src="https://demo-lookincasino.com/img/img-blue-dummy-2.jpg">
                        <img src="https://demo-lookincasino.com/img/img-blue-dummy-2.jpg">
                        <img src="https://demo-lookincasino.com/img/img-blue-dummy-2.jpg">
                        <img src="https://demo-lookincasino.com/img/img-blue-dummy-2.jpg">
                        <img src="https://demo-lookincasino.com/img/img-blue-dummy-2.jpg">
                    ...
                    <div class="casino-description">
                        <div class="block-title">
                            Добро пожаловать в казино Eclipse 
                        </div>
                        <div class="descr">
                            <p>
                                В казино Eclipse каждый найдет игру по душе. Здесь представлены суперсовременные игровые терминалы, столы для американской рулетки, карточные столы с Black Jack, Russian Poker, Oasis Poker, Casino Texas Hold’em, Baccarat и пр. Для любителей кэш-игры круглосуточно работает Покерный клуб.
                            </p>
                            <p>
                        ...
                        <div class="terms-rules">
                            <a download href="/" class="terms-link">
                                Правила <br>
                                посещения казино
                            </a>
                            <a download href="/" class="terms-link">
                                Правила приема ставок <br>
                                и выплаты выигрышей
                            </a>
                            <a download href="/" class="terms-link">
                    ...
                    <div class="casino-equipment">
                        ...
                        <div class="equipment-items">
                            ...
                            <a href="/" class="button white-bluelight order-tour">
                                Забронировать тур
                            </a>
                    ...
                    <div class="casino-games">
                        ...
                        <div class="game-items">
                            <div class="equipment-item game-item roulette">
                                <div class="title">
                                    Рулетка
                                </div>
                                <div class="text">
                                    <div class="text-inner">
                                        Краткое описание на несколько строк, правила и условия игры
                                    </div>
                                </div>
                            </div>
                            <div class="equipment-item game-item blackjack">
                                <div class="title">
                                    Блекджек
                                </div>
                                <div class="text">
                            ...
                            <div class="equipment-item game-item poker">
                                <div class="title">
                                    Покер
                                </div>
                                <div class="text">
                            ...
                            <div class="equipment-item game-item baccarat">
                                <div class="title">
                                    Баккара
                                </div>
                                <div class="text">
