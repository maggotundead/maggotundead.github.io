...
<head>
    <meta charset="UTF-8">
    <title>Бек офис - для игроков | Главная</title>
    ...
    <div class="wrapper">
        ...
        <main class="backoffice-content">
            <div class="wrap">
                ...
                <div class="page-blocks backoffice-for-players">
                    <div class="block-charts-statistic">
                        ...
                        <div class="content-block saving-account">
                            <div class="title">
                                Накопительный счет
                            </div>
                            <div class="balance-details">
                        ...
                        <div class="content-block bonus-points">
                            <div class="title">
                                Бонусные баллы
                            </div>
                            <div class="balance-details">
                        ...
                        <div class="establishment-tabs">
                            ...
                            <div class="establishment-tab poker-clubs">
                                <div class="establishment-list-item">
                                    ...
                                    <div class="column review">
                                        <a href="/" class="button white-bluelight casino-link">
                                            Обзор
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="content-block block-booking">
                        <div class="title">
                            Мои бронирования
                        </div>
                        <div class="booking-list">
                            <div class="booking-item">
                                <div class="booking-logo orange">
                                ...
                                <a href="/" class="booking-details">
                                    Подробнее >
                                </a>
                            </div>
                            <div class="booking-item">
                                <div class="booking-logo"></div>
                                <div class="booking-title">
                                    Casino #1
                                </div>
                                <div class="booking-date">
