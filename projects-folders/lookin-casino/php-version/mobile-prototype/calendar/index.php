...
<body class="inner-page">
    <div class="wrapper">
        <header class="header fixed">
            ...
            <div class="burger-menu">
                ...
                <ol class="burger-menu-list">
                    ...
                    <li>
                        <a href="casino-review.html">
                            Обзор казино
                        </a>
                    </li>
                    <li>
                        <a href="casino-rating.html">
                            Рейтинг казино
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="individual-casino.html">
                            Индивидуальная страница казино
                        </a>
                        <ol>
                            <li>
                                <a href="individual-casino-casino.html">
                                    Казино
                                </a>
                            </li>
                            <li>
                                <a href="individual-casino-hotel.html">
                                    Отель
                                </a>
                            </li>
                            <li>
                                <a href="individual-casino-restaurant.html">
                                    Ресторан
                                </a>
                            </li>
                        </ol>
        ...
        <main class="content">
            <section class="block-slider-banner" style="background-image: url('https://demo-lookincasino.com/mobile-prototype/img/dummy/calendar-banner.jpg');">
                ...
                <div class="slider-banner">
                    <div class="slide">
                        ...
                        <div class="slide-text">
                            В Eclipse casino 9 сентября прошло женское вокально-танцевальное, костюмированное шоу. Проект EVDOKIMOV-THATRE. Высокопрофессиональный вокал солисток, актёрское мастерство танцовщиц и шикарные костюмы покорят любую аудиторию.
                        </div>
                    </div>
                    <div class="slide">
                        <div class="slide-title">
    ...
    <script src="https://demo-lookincasino.com/mobile-prototype/js/calendar.js"></script>
</body>
</html>