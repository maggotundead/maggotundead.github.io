...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://demo-lookincasino.com/css/calendar.css">
...
<body>
    ...
    <div class="wrapper">
        ...
        <main class="content">
            ...
            <section class="block block-banner-slider text" style="background-image: url('https://demo-lookincasino.com/img/calendar-banner.jpg');">
                <div class="wrap">
                        ...
                        <div class="slide">
                            <div class="slide-content">
                                ...
                                <div class="slide-title-descr">
                                    Evdokimov Show Girls
                                </div>
                                <div class="slide-descr">
                                    <p>
                                        В Eclipse casino 9 сентября прошло женское вокально-танцевальное, костюмированное шоу. <br>
                                        Проект EVDOKIMOV-THEATRE. <br>
                                        Высокопрофессиональный вокал солисток, актёрское мастерство танцовщиц и шикарные костюмы покорят любую аудиторию.
                                    </p>
                                </div>
            ...
            <section class="block block-search-form">
                <div class="wrap">
                    <div class="search-form-container">
                        ...
                        <form class="search-form events-advanced-search-form">
            ...
            <section class="block block-calendar">
                <div class="wrap">
                    <div class="calendar calendar-single" id="calendar"></div>
                </div>
            </section>
    ...
    <script type="text/javascript" src="https://demo-lookincasino.com/js/calendar.js"></script>
